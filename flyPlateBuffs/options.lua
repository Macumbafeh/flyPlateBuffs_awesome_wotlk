...
fPB.MainOptionTable = {
    ...
    args = {
		...
		enableOpenIcons = {
			order = 10,
			type = "toggle",
            name = "Enable Duration Icons",
			width = "full",
            desc = "Show the duration of Flare and Consecration rank 1 on enemy nameplates when they are used to know when they will end. It shows also the duration of pets like Water elem and Shadowfiend",
